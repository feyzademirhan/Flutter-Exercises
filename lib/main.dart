              ...
              const DrawerHeader(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: NetworkImage('https://images.unsplash.com/photo-1604871038809-0462d7c3a3a0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80'),
                    fit: BoxFit.cover,
                  ),
                ...
                child: Text('M E N U', style: TextStyle(
                    shadows: <Shadow>[
                  Shadow(
          ...
          Container (
            ...
            child: const Text(
              "Picture a wave in the ocean. "
                  ...
                  "It's a wave. "
                  "And then it chrashes on the shore, and it's gone. "
                  "But the water is still there. The wave was just a different way for the water to be for a little while.",
              textAlign: TextAlign.justify,
              overflow: TextOverflow.ellipsis,
              style: TextStyle(fontSize: 18.0, fontFamily: 'Pacifico', color: Colors.black54),
              maxLines: 5,
            ),
          ),
          SizedBox(height: 8.0),
